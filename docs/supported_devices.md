...
| -- | -- | -- | -- | -- | :--: | :-------------------------------------- | :------------------------------ | ----: | ------: | :----- |
| 🟧 | ✔️ | 🇲 | 🔌 | 🛜 | **TL** | `_TZ3210_aksyshpw` <br> `TS0003` | [Tuya common 3-gang](https://www.zigbee2mqtt.io/devices/TS0003_switch_module_1.html) |   |   | Needs relay pinout confirmation (C0, B4, B5 suspected) | 
